import partnerAppScreenshot from '@assets/partner_screenshot.png'; 
...
const PartnerAppHero: FC = () => {
  ...
  const googlePlayUrl = "https://play.google.com/store/apps/details?id=tn.logisty.partner";
        ...
        <div className="hero-main-grid">
          ...
          <div className="hero-text-content">
            <header className="hero-header">
              <div className="beta-status">PARTNER NETWORK LIVE</div>
              <h1 className="hero-title">
                Logisty <span className="title-stroke">Partner</span>
              </h1>
            ...
            <div className="onboarding-flow">
              ...
              <div className="flow-item">
                ...
                <div className="flow-body">
                  ...
                  <p>Join the partner group to verify your carrier credentials.</p>
              ...
              <div className="flow-item">
                ...
                <div className="flow-body">
                  <h3>Start Driving</h3>
                  <p>Download the driver app from the Play Store.</p>
          ...
          <div className="hero-visual-content">
            <div className="phone-wrapper">
               <img src={partnerAppScreenshot} alt="Logisty Partner App" className="phone-asset" />
            </div>
          </div>
